...
func (r *RoleRepo) CreateRole(ctx context.Context, data *RoleRequest) (*RoleResponse, error) {
	now := time.Now()
...
// 获取角色列表
func (r *RoleRepo) GetRoleList(ctx context.Context, pageIndex, pageSize int) ([]*RoleResponse, int64, error) {
...
// 根据角色ID获取角色
func (r *RoleRepo) GetRoleById(ctx context.Context, roleId string) (*RoleResponse, error) {
...
// 根据角色ID列表批量获取角色
func (r *RoleRepo) GetRolesByIds(ctx context.Context, roleIds []string) ([]*RoleResponse, error) {
	if len(roleIds) == 0 {
...
func (r *RoleRepo) FindByName(ctx context.Context, name string) (*RoleResponse, error) {
	var role RoleResponse
